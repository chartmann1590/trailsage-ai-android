# TrailSage AI Developer Guide

This document contains instructions for building, compiling, and contributing to the TrailSage AI Android application.

## Build Requirements

To build TrailSage AI, ensure you have Java Development Kit (JDK) 21 installed. Set your `JAVA_HOME` environment variable and run the Gradle tasks:
